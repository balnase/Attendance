...
public class MapsActivity extends AppCompatActivity {
    ...
    private String UPLOAD_URL = "http://direktoriku.com/android/includes/upload_image/upload.php";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(MapsActivity.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
